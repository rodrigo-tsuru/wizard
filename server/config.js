...
module.exports = {
  mongo: {
    ...
    apiKey: '_WehX6VgyPr0h45Rza1JwnR17aLGCeW2'                 // Our MongoLab API key
  },
  security: {
    dbName: 'wizard',                                   // The name of database that contains the security information
  ...
  server: {
    ...
    cookieSecret: 'wizard'                         // The secret for encrypting the cookie
  }
};
